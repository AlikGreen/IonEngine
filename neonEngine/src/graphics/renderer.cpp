...
namespace Neon
{
    CulledRenderables Renderer::performCulling(Scene &scene, ECS::Entity camEntity)
    {
    ...
    CameraUniformData Renderer::getCameraUniformData(ECS::Entity camEntity)
    {
    ...
    void Renderer::execute(const Rc<RHI::CommandList> &cmd, RenderContext &ctx)
    {
